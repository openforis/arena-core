...
const getNodeRootUuid = (index: RecordNodesIndex): string | undefined => {
  const shortenUuid = index.nodeRootUuid
  return shortenUuid ? index.uuidByShortenUuid?.[shortenUuid] ?? shortenUuid : shortenUuid
}
