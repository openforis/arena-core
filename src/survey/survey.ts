...
export enum SurveyDependencySubtype {
  nodeDefs = 'nodeDefs',
  nodePaths = 'nodePaths',
}

export interface SurveyDependency {
  [SurveyDependencySubtype.nodeDefs]?: { [nodeDefUuid: string]: string[] | boolean }
  [SurveyDependencySubtype.nodePaths]?: { [nodeDefUuid: string]: string[] }
}
