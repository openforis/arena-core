...
export const Languages: {
  ...
  [LanguageCode.ab]: { [en]: 'Abkhazian' },
  [LanguageCode.aa]: { [en]: 'Afar' },
  [LanguageCode.af]: { [en]: 'Afrikaans' },
  [LanguageCode.ak]: { [en]: 'Akan' },
  [LanguageCode.sq]: { [en]: 'Albanian' },
  [LanguageCode.am]: { [en]: 'Amharic' },
  [LanguageCode.ar]: { [en]: 'Arabic' },
  [LanguageCode.an]: { [en]: 'Aragonese' },
  [LanguageCode.hy]: { [en]: 'Armenian' },
  [LanguageCode.as]: { [en]: 'Assamese' },
  [LanguageCode.av]: { [en]: 'Avaric' },
  [LanguageCode.ay]: { [en]: 'Aymara' },
  [LanguageCode.az]: { [en]: 'Azerbaijani' },
  [LanguageCode.bm]: { [en]: 'Bambara' },
  [LanguageCode.ba]: { [en]: 'Bashkir' },
  [LanguageCode.eu]: { [en]: 'Basque' },
  [LanguageCode.be]: { [en]: 'Belarusian' },
  [LanguageCode.bn]: { [en]: 'Bengali' },
  [LanguageCode.bi]: { [en]: 'Bislama' },
  [LanguageCode.nb]: { [en]: 'Bokmål, Norwegian; Norwegian Bokmål' },
  [LanguageCode.bs]: { [en]: 'Bosnian' },
  [LanguageCode.br]: { [en]: 'Breton' },
  [LanguageCode.bg]: { [en]: 'Bulgarian' },
  [LanguageCode.my]: { [en]: 'Burmese' },
  [LanguageCode.ca]: { [en]: 'Catalan; Valencian' },
  [LanguageCode.km]: { [en]: 'Central Khmer' },
  [LanguageCode.ch]: { [en]: 'Chamorro' },
  [LanguageCode.ce]: { [en]: 'Chechen' },
  [LanguageCode.ny]: { [en]: 'Chichewa; Chewa; Nyanja' },
  [LanguageCode.zh]: { [en]: 'Chinese' },
  [LanguageCode.cv]: { [en]: 'Chuvash' },
  [LanguageCode.kw]: { [en]: 'Cornish' },
  [LanguageCode.co]: { [en]: 'Corsican' },
  [LanguageCode.cr]: { [en]: 'Cree' },
  [LanguageCode.hr]: { [en]: 'Croatian' },
  [LanguageCode.cs]: { [en]: 'Czech' },
  [LanguageCode.da]: { [en]: 'Danish' },
  [LanguageCode.dv]: { [en]: 'Divehi; Dhivehi; Maldivian' },
  [LanguageCode.nl]: { [en]: 'Dutch; Flemish' },
  [LanguageCode.dz]: { [en]: 'Dzongkha' },
  [LanguageCode.en]: { [en]: 'English' },
  [LanguageCode.eo]: { [en]: 'Esperanto' },
  [LanguageCode.et]: { [en]: 'Estonian' },
  [LanguageCode.ee]: { [en]: 'Ewe' },
  [LanguageCode.fo]: { [en]: 'Faroese' },
  [LanguageCode.fj]: { [en]: 'Fijian' },
  [LanguageCode.fi]: { [en]: 'Finnish' },
  [LanguageCode.fr]: { [en]: 'French' },
  [LanguageCode.ff]: { [en]: 'Fulah' },
  [LanguageCode.gd]: { [en]: 'Gaelic; Scottish Gaelic' },
  [LanguageCode.gl]: { [en]: 'Galician' },
  [LanguageCode.lg]: { [en]: 'Ganda' },
  [LanguageCode.ka]: { [en]: 'Georgian' },
  [LanguageCode.de]: { [en]: 'German' },
  [LanguageCode.el]: { [en]: 'Greek, Modern (1453-)' },
  [LanguageCode.gn]: { [en]: 'Guarani' },
  [LanguageCode.gu]: { [en]: 'Gujarati' },
  [LanguageCode.ht]: { [en]: 'Haitian; Haitian Creole' },
  [LanguageCode.ha]: { [en]: 'Hausa' },
  [LanguageCode.he]: { [en]: 'Hebrew' },
  [LanguageCode.hz]: { [en]: 'Herero' },
  [LanguageCode.hi]: { [en]: 'Hindi' },
  [LanguageCode.ho]: { [en]: 'Hiri Motu' },
  [LanguageCode.hu]: { [en]: 'Hungarian' },
  [LanguageCode.is]: { [en]: 'Icelandic' },
  [LanguageCode.io]: { [en]: 'Ido' },
  [LanguageCode.ig]: { [en]: 'Igbo' },
  [LanguageCode.id]: { [en]: 'Indonesian' },
  [LanguageCode.ia]: { [en]: 'Interlingua (International Auxiliary Language Association)' },
  [LanguageCode.ie]: { [en]: 'Interlingue; Occidental' },
  [LanguageCode.iu]: { [en]: 'Inuktitut' },
  [LanguageCode.ik]: { [en]: 'Inupiaq' },
  [LanguageCode.ga]: { [en]: 'Irish' },
  [LanguageCode.it]: { [en]: 'Italian' },
  [LanguageCode.ja]: { [en]: 'Japanese' },
  [LanguageCode.jv]: { [en]: 'Javanese' },
  [LanguageCode.kl]: { [en]: 'Kalaallisut; Greenlandic' },
  [LanguageCode.kn]: { [en]: 'Kannada' },
  [LanguageCode.kr]: { [en]: 'Kanuri' },
  [LanguageCode.ks]: { [en]: 'Kashmiri' },
  [LanguageCode.kk]: { [en]: 'Kazakh' },
  [LanguageCode.ki]: { [en]: 'Kikuyu; Gikuyu' },
  [LanguageCode.rw]: { [en]: 'Kinyarwanda' },
  [LanguageCode.ky]: { [en]: 'Kirghiz; Kyrgyz' },
  [LanguageCode.kv]: { [en]: 'Komi' },
  [LanguageCode.kg]: { [en]: 'Kongo' },
  [LanguageCode.ko]: { [en]: 'Korean' },
  [LanguageCode.kj]: { [en]: 'Kuanyama; Kwanyama' },
  [LanguageCode.ku]: { [en]: 'Kurdish' },
  [LanguageCode.lo]: { [en]: 'Lao' },
  [LanguageCode.lv]: { [en]: 'Latvian' },
  [LanguageCode.li]: { [en]: 'Limburgan; Limburger; Limburgish' },
  [LanguageCode.ln]: { [en]: 'Lingala' },
  [LanguageCode.lt]: { [en]: 'Lithuanian' },
  [LanguageCode.lu]: { [en]: 'Luba-Katanga' },
  [LanguageCode.lb]: { [en]: 'Luxembourgish; Letzeburgesch' },
  [LanguageCode.mk]: { [en]: 'Macedonian' },
  [LanguageCode.mg]: { [en]: 'Malagasy' },
  [LanguageCode.ms]: { [en]: 'Malay' },
  [LanguageCode.ml]: { [en]: 'Malayalam' },
  [LanguageCode.mt]: { [en]: 'Maltese' },
  [LanguageCode.gv]: { [en]: 'Manx' },
  [LanguageCode.mi]: { [en]: 'Maori' },
  [LanguageCode.mr]: { [en]: 'Marathi' },
  [LanguageCode.mh]: { [en]: 'Marshallese' },
  [LanguageCode.mn]: { [en]: 'Mongolian' },
  [LanguageCode.na]: { [en]: 'Nauru' },
  [LanguageCode.nv]: { [en]: 'Navajo; Navaho' },
  [LanguageCode.nd]: { [en]: 'Ndebele, North; North Ndebele' },
  [LanguageCode.nr]: { [en]: 'Ndebele, South; South Ndebele' },
  [LanguageCode.ng]: { [en]: 'Ndonga' },
  [LanguageCode.ne]: { [en]: 'Nepali' },
  [LanguageCode.se]: { [en]: 'Northern Sami' },
  [LanguageCode.no]: { [en]: 'Norwegian' },
  [LanguageCode.nn]: { [en]: 'Norwegian Nynorsk; Nynorsk, Norwegian' },
  [LanguageCode.oc]: { [en]: 'Occitan (post 1500); Provençal' },
  [LanguageCode.oj]: { [en]: 'Ojibwa' },
  [LanguageCode.or]: { [en]: 'Oriya' },
  [LanguageCode.om]: { [en]: 'Oromo' },
  [LanguageCode.os]: { [en]: 'Ossetian; Ossetic' },
  [LanguageCode.pa]: { [en]: 'Panjabi; Punjabi' },
  [LanguageCode.fa]: { [en]: 'Persian' },
  [LanguageCode.pl]: { [en]: 'Polish' },
  [LanguageCode.pt]: { [en]: 'Portuguese' },
  [LanguageCode.ps]: { [en]: 'Pushto; Pashto' },
  [LanguageCode.qu]: { [en]: 'Quechua' },
  [LanguageCode.ro]: { [en]: 'Romanian; Moldavian; Moldovan' },
  [LanguageCode.rm]: { [en]: 'Romansh' },
  [LanguageCode.rn]: { [en]: 'Rundi' },
  [LanguageCode.ru]: { [en]: 'Russian' },
  [LanguageCode.sm]: { [en]: 'Samoan' },
  [LanguageCode.sg]: { [en]: 'Sango' },
  [LanguageCode.sc]: { [en]: 'Sardinian' },
  [LanguageCode.sr]: { [en]: 'Serbian' },
  [LanguageCode.sn]: { [en]: 'Shona' },
  [LanguageCode.ii]: { [en]: 'Sichuan Yi; Nuosu' },
  [LanguageCode.sd]: { [en]: 'Sindhi' },
  [LanguageCode.si]: { [en]: 'Sinhala; Sinhalese' },
  [LanguageCode.sk]: { [en]: 'Slovak' },
  [LanguageCode.sl]: { [en]: 'Slovenian' },
  [LanguageCode.so]: { [en]: 'Somali' },
  [LanguageCode.st]: { [en]: 'Sotho, Southern' },
  [LanguageCode.es]: { [en]: 'Spanish' },
  [LanguageCode.su]: { [en]: 'Sundanese' },
  [LanguageCode.sw]: { [en]: 'Swahili' },
  [LanguageCode.ss]: { [en]: 'Swati' },
  [LanguageCode.sv]: { [en]: 'Swedish' },
  [LanguageCode.tl]: { [en]: 'Tagalog' },
  [LanguageCode.ty]: { [en]: 'Tahitian' },
  [LanguageCode.tg]: { [en]: 'Tajik' },
  [LanguageCode.ta]: { [en]: 'Tamil' },
  [LanguageCode.tt]: { [en]: 'Tatar' },
  [LanguageCode.te]: { [en]: 'Telugu' },
  [LanguageCode.th]: { [en]: 'Thai' },
  [LanguageCode.bo]: { [en]: 'Tibetan' },
  [LanguageCode.ti]: { [en]: 'Tigrinya' },
  [LanguageCode.to]: { [en]: 'Tonga (Tonga Islands)' },
  [LanguageCode.ts]: { [en]: 'Tsonga' },
  [LanguageCode.tn]: { [en]: 'Tswana' },
  [LanguageCode.tr]: { [en]: 'Turkish' },
  [LanguageCode.tk]: { [en]: 'Turkmen' },
  [LanguageCode.tw]: { [en]: 'Twi' },
  [LanguageCode.ug]: { [en]: 'Uighur; Uyghur' },
  [LanguageCode.uk]: { [en]: 'Ukrainian' },
  [LanguageCode.ur]: { [en]: 'Urdu' },
  [LanguageCode.uz]: { [en]: 'Uzbek' },
  [LanguageCode.ve]: { [en]: 'Venda' },
  [LanguageCode.vi]: { [en]: 'Vietnamese' },
  [LanguageCode.vo]: { [en]: 'Volapük' },
  [LanguageCode.wa]: { [en]: 'Walloon' },
  [LanguageCode.cy]: { [en]: 'Welsh' },
  [LanguageCode.fy]: { [en]: 'Western Frisian' },
  [LanguageCode.wo]: { [en]: 'Wolof' },
  [LanguageCode.xh]: { [en]: 'Xhosa' },
  [LanguageCode.yi]: { [en]: 'Yiddish' },
  [LanguageCode.yo]: { [en]: 'Yoruba' },
  [LanguageCode.za]: { [en]: 'Zhuang; Chuang' },
  [LanguageCode.zu]: { [en]: 'Zulu' },
}

export const LanguagesISO639part2: { [key: string]: { [code in LanguageCode]?: string } } = {
...
export const LanguagesISO639part2LabelLanguages = [en, fr, de]
